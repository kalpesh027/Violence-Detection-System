...
while True:
    ...
    for result in results:
        ...
        for box in boxes:
            ...
            if currentClass == 'car' or currentClass == 'truck' or currentClass == 'bus' or classNames =='motorbike' and conf > 0.3:

                currentArray = np.array([x1,y1,x2,y2,conf])
                detections = np.vstack((detections, currentArray))

    resultTracker = tracker.update(detections)
    cv2.line(frame,(limit[0], limit[1]),( limit[2], limit[3]), (0,0,255), 2)
